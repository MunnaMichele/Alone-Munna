...
m/92m/#     #    #    #     # #    #  
 m/92m/#####     #    #     # #     # 
m/92m/whatsapp:  +9665947830m/92m/
m/92m/github:MunnaMichelem/92m/
print:m/92m/---------;;;;;------------------------------------;;;;;;;------------------;;;;;----------------
USERNAME:"khan"
password:"123"
loop='true'
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open https://www.facebook.com/MUNN4.MICH3L3  ')
    else:
...
def pilih_super():
	...
	print"\033[1;96m[+] \033[1;92mTotal OK/\x1b[1;93mCP \033[1;91m: \033[1;92m"+str(len(MunnaOk))+"\033[1;97m/\033[1;93m"+str(len(MunnaCp))
